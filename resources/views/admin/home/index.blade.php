                    ...
                    <ul class="timeline-list">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="{{asset('themes/admin/img/placeholders/photos/photo1.jpg')}}" data-toggle="lightbox-image">
                                            <img src="{{asset('themes/admin/img/placeholders/photos/photo1.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a href="{{asset('themes/admin/img/placeholders/photos/photo22.jpg')}}" data-toggle="lightbox-image">
                                            <img src="{{asset('themes/admin/img/placeholders/photos/photo22.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="active">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="{{asset('themes/admin/img/placeholders/photos/photo23.jpg')}}" data-toggle="lightbox-image">
                                            <img src="{{asset('themes/admin/img/placeholders/photos/photo23.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
